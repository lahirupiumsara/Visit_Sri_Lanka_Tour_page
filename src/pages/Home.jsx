...
import tour8 from "../assets/images/tour/nuwaraeliya.png";
import tour9 from "../assets/images/tour/jaffna.png";
          ...
          <Row>
            <Col md="12">
              <div className="main_heading">
                <h1> Top Destination For Your Next Vacation in Sri lanka </h1>
              </div>
            </Col>
          </Row>
        ...
        <Container>
          <Row className="align-items-center">
            <Col md="8">
              ...
              <p className="text">
                Got it! I'll remember your interest in visiting Sri Lanka. If
                you need more information or tips for your trip, feel free to
                ask!{" "}
              </p>
            </Col>
